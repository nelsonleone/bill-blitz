...
<main class="page px-0 md:px-0 text-primary-very-dark-blue lg:pt-20">
    <div class="relative z-10 bg-[url('/images/pexels-evie-shaffer-1259279-2748756.jpg')] h-[85vh] bg-cover bg-center py-28 px-4 md:px-6 lg:flex lg:items-center">
        <div class="absolute -z-10 top-0 bottom-0 left-0 right-0 m-auto w-full h-full bg-green-200 opacity-20"></div>
        <div class="relative z-10 lg:w-2/5 lg:ms-20">
