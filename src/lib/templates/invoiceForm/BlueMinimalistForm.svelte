...
<form class="bg-base-color1 w-full shadow-md py-12 px-4 md:px-12 border-2" style="border: 2px solid {borderColor.hex}">
    <div class="mb-4">
    ...
    <div class="my-10">
        <div class="mx-auto flex flex-col bg-emerald-800 text-base-color1 py-4 px-2 rounded-sm md:w-96 md:mx-auto">
